...
var Tablero = new function(){
	...
	this.colocarficha = function(ficha,ox,oy){
		var hueco = Tablero.buscarxcoor(ox,oy);
	  	...
	  	//Aquí le decimos si el hueco está vacío y la ficha encaja la situamos
...
// posiseguidor va a ser: 		
	/*this.cierraCampo = function(ficha, pseguidor){
		...
		var fichapasada = [];
		//Función inicial donde tenemos colocada la ficha
		var primeraficha = function(ficha, pseguidor){
			//Arriba			
			if (pseguidor == 0){
				if (ficha.izquierda == "Rue"){		
